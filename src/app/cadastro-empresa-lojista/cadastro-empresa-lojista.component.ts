...
@Component({
  selector: 'app-cadastro-empresa-lojista',
  templateUrl: './cadastro-empresa-lojista.component.html',
  styleUrls: ['./cadastro-empresa-lojista.component.css']
})
export class CadastroEmpresaLojistaComponent implements OnInit {
  listaCidades: any;
